...
namespace App1
{
    class Soap
    {
        ...
        public int[] intDocument(String _result, String whatFound)
        {
            try
            {
                XmlDocument line = new XmlDocument();
                ...
                int[] list = new int[listNode.Count];
                ...
                if (listNode.Count > 1)
                {
                    for (int i = 0; i < listNode.Count; i++)
                    {
                        ...
                        list[i] = int.Parse(nodeList.InnerText);
                    }
                }
                else if (listNode.Count == 1)
                {
                    ...
                    list[0] = int.Parse(nodeList.InnerText);
                }
                else
                {
                    return null;
